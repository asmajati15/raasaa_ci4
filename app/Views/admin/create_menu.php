...
<div class="container">
  <div class="row">
    <div class="col-8">
      ...
      <form action="/admin/saveMenu" method="POST" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <textarea type="text" class="form-control <?= ($validation->hasError('deskripsi')) ? 'is-invalid' : ''; ?>" id="deskripsi" name="deskripsi" cols="30" rows="10" value="<?= old('deskripsi'); ?>">
            </textarea>
            <div class="invalid-feedback">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <select id="Select" class="form-select" id="jenis" name="jenis" value="<?= old('jenis'); ?>">
              <option value="" hidden></option>
              <?php foreach ($makanan as $mk) : ?>
                <option value="<?= $mk['id']; ?>"><?= $mk['jenis']; ?></option>
              <?php endforeach; ?>
            </select>
          </div>
        </div>
